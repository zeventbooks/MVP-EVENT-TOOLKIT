...
async function main() {
  ...
  // ═══════════════════════════════════════════════════════════════
  log(`\n${c.bold}[1/4] Code Quality${c.reset}`, c.cyan);
  ...
  // GATE 2: Unit Tests
  // ═══════════════════════════════════════════════════════════════
  log(`\n${c.bold}[2/4] Unit Tests${c.reset}`, c.cyan);
  ...
  // ═══════════════════════════════════════════════════════════════
  log(`\n${c.bold}[3/4] Contract Tests${c.reset}`, c.cyan);
  ...
  // ═══════════════════════════════════════════════════════════════
  log(`\n${c.bold}[4/4] Schema Validation${c.reset}`, c.cyan);
